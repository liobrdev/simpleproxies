  ...
  render() {
    const breadcrumbList: IBreadcrumbListItem[] = [
      ...
      },
      {
        ...
        item: "https://simpleproxies.app/terms"
      }
    ];
    ...
    return (
      <>
        <Head>
          <title>Terms and Conditions - SimpleProxies</title>
        ...
        <main className='Page Page--legal'>
          ...
          <div className='LegalText'>
            ...
            <ul>
              <li>
                <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named SimpleProxies</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SimpleProxies.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to SimpleProxies, accessible from <a href="https://simpleproxies.app" rel="external nofollow noopener noreferrer" target="_blank">https://simpleproxies.app</a></p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: contact@simpleproxies.app</li>
            </ul>
          </div>
